...
defmodule PhoenixChatWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: PhoenixChatWeb.Coherence.EmailView, layout: {PhoenixChatWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
  alias Coherence.Config
  import PhoenixChatWeb.Gettext

  defp site_name, do: "Sprint-Retro"
